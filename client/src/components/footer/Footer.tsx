            ...
            <footer className="w-full py-14">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <ul className="text-md flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                            <li><a href="#" className="font-size-10 text-gray-800 hover:text-gray-900">Pagedone</a></li>
                            <li><a href="#" className="font-size-10 text-gray-800 hover:text-gray-900">Products</a></li>
                            <li><a href="#" className="font-size-10 text-gray-800 hover:text-gray-900">Resources</a></li>
                            <li><a href="#" className="font-size-10 text-gray-800 hover:text-gray-900">Blogs</a></li>
                            <li><a href="#" className="font-size-10 text-gray-800 hover:text-gray-900">Support</a></li>
                        </ul>
                        ...
                        <span className="text-md text-gray-500 text-center block">©<a href="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.treehugger.com%2Fbeavers-things-know-about-natures-landscape-engineers-4863345&psig=AOvVaw1YsjEK2pYZ1uWn9CMt4Ze9&ust=1736195587206000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCMjNkdy234oDFQAAAAAdAAAAABAp">beaver</a> 2025, All rights reserved.</span>
                    </div>
                </div>
            </footer>
