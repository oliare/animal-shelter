    ...
    return (
        <div className={styles['container']}>
            <div className={styles['who-we-are']}>
                ...
                <div className={styles['achievements']}><span className={styles['number']}>1100</span> Pets adopted</div>
                <div className={styles['about-image']}>
                    <img src="/images/cats/foxy-cats.png" alt="Who We Are" />
                </div>
            </div>

            <div className={`${styles['our-mission']} my-10`}>
                <div className={styles['about-image']}>
                    <img src="/images/dogs/dog.png" alt="Our Mission" />
                </div>
                <div className={styles['achievements']}><span className={styles['number']}>500+</span>Volunteers</div>
                <div className={styles['about-content']}>
                    <h2>Our Mission</h2>
                    <p>
            ...
            <div className={styles['what-we-do']}>
                ...
                <div className={styles['achievements']}><span className={styles['number']}>1k</span> Donations raised</div>
                <div className={styles['about-image']}>
